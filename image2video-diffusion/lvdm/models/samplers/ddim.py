...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
        ...
        if verbose:
            iterator = tqdm(time_range, desc=f'🎬 Generating {shape[2]} frames', total=total_steps, 
        ...
        for i, step in enumerate(iterator):
            ...
            if verbose and hasattr(iterator, 'set_description'):
                ...
                iterator.set_description(f'🎬 Generating {shape[2]} frames - Step {i+1}/{total_steps} ({progress_percent:.1f}%)')
